...
public class IngameOverlayGUI extends GUI {
	...
	public void calc() {
		...
		statsName.setBounds(Calc.getPixelWidth(0.075f), 0, Calc.getPixelWidth(0.1f),
		...
		hotbarBlockStone.setBounds(Calc.getPixelWidth(0.547f), 0, Calc.getPixelWidth(0.047f), Calc.getPixelHeight(0.083f));
		hotbarBlockStoneNumber.setBounds(Calc.getPixelWidth(0.575f), Calc.getPixelHeight(0.02f), Calc.getPixelWidth(0.1f),
	...
	private void init() {
		...
		statsName = new GLabel(Calc.getPixelWidth(0.075f), 0, Calc.getPixelWidth(0.1f),
				Calc.getPixelHeight(0.08f));
		statsName.setText("UNKNOWN", SkyFightClient.CalibriB20, new Vector4f(0.2f, 0.18f, 0.17f, 1f),
				TEXT_ALIGN.LEFT, 0);
		this.addComponent(statsName); 
		
		statsHeart= new GLabel(Calc.getPixelWidth(0.075f), Calc.getPixelHeight(0.055f), Calc.getPixelWidth(0.019f), Calc.getPixelHeight(0.028f));
		...
		statsHeartPoints = new GLabel(Calc.getPixelWidth(0.1f), Calc.getPixelHeight(0.035f), Calc.getPixelWidth(0.1f),
				Calc.getPixelHeight(0.08f));
		statsHeartPoints.setText("--- / 100", SkyFightClient.Alba18, new Vector4f(0, 0, 0, 1f),
				TEXT_ALIGN.LEFT, 0);
		this.addComponent(statsHeartPoints);
		
		statsCoin = new GLabel(Calc.getPixelWidth(0.075f), Calc.getPixelHeight(0.095f), Calc.getPixelWidth(0.016f), Calc.getPixelHeight(0.033f));
		...
		statsCoinPoints = new GLabel(Calc.getPixelWidth(0.1f), Calc.getPixelHeight(0.08f), Calc.getPixelWidth(0.1f),
				Calc.getPixelHeight(0.08f));
		statsCoinPoints.setText("--", SkyFightClient.Alba18, new Vector4f(0, 0, 0, 1f),
				TEXT_ALIGN.LEFT, 0);
		this.addComponent(statsCoinPoints);
		
		hotbarLinks = new GLabel(Calc.getPixelWidth(0.398f), 0, Calc.getPixelWidth(0.008f), Calc.getPixelHeight(0.083f));
		hotbarLinks.setTexture(SkyFightClient.IngameOverlayHotbarLinks);
		this.addComponent(hotbarLinks);
		
		hotbarMitte1 = new GLabel(Calc.getPixelWidth(0.406f), 0, Calc.getPixelWidth(0.047f), Calc.getPixelHeight(0.083f));
		hotbarMitte1.setTexture(SkyFightClient.IngameOverlayHotbarMitte);
		this.addComponent(hotbarMitte1);
		
		hotbarSword = new GLabel(Calc.getPixelWidth(0.406f), 0, Calc.getPixelWidth(0.047f), Calc.getPixelHeight(0.083f));
		...
		hotbarMitte2 = new GLabel(Calc.getPixelWidth(0.453f), 0, Calc.getPixelWidth(0.0477f), Calc.getPixelHeight(0.083f));
		...
		hotbarPickaxe = new GLabel(Calc.getPixelWidth(0.5f), 0, Calc.getPixelWidth(0.047f), Calc.getPixelHeight(0.083f));
		...
		hotbarMitte4 = new GLabel(Calc.getPixelWidth(0.547f), 0, Calc.getPixelWidth(0.047f), Calc.getPixelHeight(0.083f));
		hotbarMitte4.setTexture(SkyFightClient.IngameOverlayHotbarMitte);
		this.addComponent(hotbarMitte4);
		
		hotbarBlockStone = new GLabel(Calc.getPixelWidth(0.547f), 0, Calc.getPixelWidth(0.047f), Calc.getPixelHeight(0.083f));
		...
		hotbarBlockStoneNumber = new GLabel(Calc.getPixelWidth(0.575f), Calc.getPixelHeight(0.02f), Calc.getPixelWidth(0.1f),
				Calc.getPixelHeight(0.1f));
		hotbarBlockStoneNumber.setText("--", SkyFightClient.Alba18, new Vector4f(1f, 1f, 1f, 1f),
				TEXT_ALIGN.LEFT, 0);
		this.addComponent(hotbarBlockStoneNumber);
		
		hotbarRechts = new GLabel(Calc.getPixelWidth(0.594f), 0, Calc.getPixelWidth(0.008f), Calc.getPixelHeight(0.083f));
		hotbarRechts.setTexture(SkyFightClient.IngameOverlayHotbarRechts);
		this.addComponent(hotbarRechts);
		
		hotbarHover = new GLabel(selectedLabel.getX(), selectedLabel.getY(), selectedLabel.getWidth(), selectedLabel.getHeight());
